                        ...
                        <div class="p-6 bg-white">                    
                            ...
                            <div class="col-span-6 sm:col-span-6 lg:col-span-2">
                                <a href="{{ route('funcionarios.create') }}">
                                    <x-button type="submit" class="m-4">{{ __('Cadastrar Novo Colaborador') }}</x-button>
                                </a>
                            </div>
                            <br>
                            <div class="col-span-6 sm:col-span-6 lg:col-span-2">
                                <form action="{{ route('funcionarios.index') }}" method="GET">
                                    ...
                                    <br> 
                                    <small>Preencha com o nome ou matricula do colaborador.</small>
                                    <br><br><br>
                                </form>
                            </div>
                                    ...
                                    <tbody>  
                                        @foreach ($funcionarios as $funcionario)
                                            <tr>
                                                ...
                                                @endif
                                                @if(auth()->user()->can('deletar_colaborador'))
